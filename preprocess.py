...
if __name__ == "__main__":
    ...
    chunks = chunker.chunk_html_with_enhanced_metadata("https://squidfunk.github.io/mkdocs-material/setup/setting-up-navigation/")

    text_records, image_records = extract_records_from_chunks(chunks, base_url="https://squidfunk.github.io/mkdocs-material/setup/setting-up-navigation/")
