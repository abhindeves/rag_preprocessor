...
class MultimodalEnhancer:
    ...
    def __init__(self, output_path: str = "./enhanced_output/"):
        self.output_path = output_path
        os.makedirs(self.output_path, exist_ok=True)
        self.summarizer = TechnicalDocumentImageSummarizer()
    ...
    def _generate_image_summary(self, alt_text: str, image_url: str, context_text: Optional[str] = None) -> str:
        ...
        result = self.summarizer.summarize_technical_image(
            image_url=image_url,
    ...
    def _generate_table_summary(self, table_html: str, table_structure: Dict, context_text: Optional[str] = None) -> str:
        ...
        table_result = self.summarizer.summarize_technical_table(
                table_html=table_html,
                text_context=context_text,
                custom_instructions="",
                model="gpt-4o-mini",
...
def enhance_extraction_pipeline(processor: RAGHTMLProcessor, text_records, image_records, table_records, output_path: str):
    """
    ...
    enhancer = MultimodalEnhancer(output_path=output_path)
...
if __name__ == "__main__":
    ...
    output_path = "./output/"
    enhanced_output_path = "./enhanced_output/"
    
    print("COMPLETE RAG HTML CHUNKING SYSTEM WITH MULTIMODAL ENHANCEMENT")
    print()
    ...
    # Step 7: Run the enhanced pipeline
    enhanced_records = enhance_extraction_pipeline(processor, text_records, image_records, table_records, enhanced_output_path)    
